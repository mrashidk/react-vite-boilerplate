...
const Modal: FC<ModalProps> = ({ children, title, open, onClose, footer, className, closable }) => {
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="purple-theme relative z-[2147483601]" onClose={(closable && onClose) || (() => {})}>
        ...
        <div className="fixed inset-0 z-[2147483601] max-w-[100vw]">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel
                className={cn(
                  'relative mx-auto transform rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:m-8 sm:w-full sm:p-6',
                  className,
                )}
              >
